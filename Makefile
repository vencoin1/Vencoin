...
pkgdatadir = $(datadir)/venture
pkgincludedir = $(includedir)/venture
pkglibdir = $(libdir)/venture
pkglibexecdir = $(libexecdir)/venture
...
CONFIG_HEADER = $(top_builddir)/src/config/venture-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/venture-config.h.in \
...
ACLOCAL = ${SHELL} /home/venture-core/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/venture-core/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/venture-core/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/venture-core/build-aux/missing automake-1.15
AWK = gawk
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = venture-cli
BITCOIN_DAEMON_NAME = ventured
BITCOIN_GUI_NAME = venture-qt
BITCOIN_TX_NAME = venture-tx
...
MAINT = 
MAKEINFO = ${SHELL} /home/venture-core/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
PACKAGE_NAME = VENTURE Core
PACKAGE_STRING = VENTURE Core 2.0.0
PACKAGE_TARNAME = venture
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /home/venture-core
abs_srcdir = /home/venture-core
abs_top_builddir = /home/venture-core
abs_top_srcdir = /home/venture-core
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/venture-core/build-aux/install-sh
...
OSX_INSTALLER_ICONS = $(top_srcdir)/src/qt/res/icons/bitcoin2.icns
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_venture_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_venture_coverage.info test_venture.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin2.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/VENcoin-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/venture-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/venture-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/venture-config.h
$(top_srcdir)/src/config/venture-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/venture-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/Resources/bitcoin2.icns: $(OSX_INSTALLER_ICONS)
	$(MKDIR_P) $(@D)
	$(INSTALL_DATA) $< $@

$(OSX_APP)/Contents/MacOS/VENcoin-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/VENcoin-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/VENcoin-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_venture.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_venture -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_venture_filtered.info: test_venture.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_venture_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_venture_coverage.info: baseline_filtered_combined.info test_venture_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_venture_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_venture_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_venture_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_venture.coverage/.dirstamp:  test_venture_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_venture.coverage/.dirstamp total.coverage/.dirstamp

.INTERMEDIATE: $(COVERAGE_INFO)

clean-local:
	rm -rf test_venture.coverage/ total.coverage/ $(OSX_APP)
