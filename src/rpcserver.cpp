...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* VENTURE features */
        {"VENTURE", "masternode", &masternode, true, true, false},
        {"VENTURE", "listmasternodes", &listmasternodes, true, true, false},
        {"VENTURE", "getmasternodecount", &getmasternodecount, true, true, false},
        {"VENTURE", "masternodeconnect", &masternodeconnect, true, true, false},
        {"VENTURE", "masternodecurrent", &masternodecurrent, true, true, false},
        {"VENTURE", "masternodedebug", &masternodedebug, true, true, false},
        {"VENTURE", "startmasternode", &startmasternode, true, true, false},
        {"VENTURE", "createmasternodekey", &createmasternodekey, true, true, false},
        {"VENTURE", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"VENTURE", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"VENTURE", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"VENTURE", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"VENTURE", "getmasternodescores", &getmasternodescores, true, true, false},
        {"VENTURE", "mnbudget", &mnbudget, true, true, false},
        {"VENTURE", "preparebudget", &preparebudget, true, true, false},
        {"VENTURE", "submitbudget", &submitbudget, true, true, false},
        {"VENTURE", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"VENTURE", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"VENTURE", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"VENTURE", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"VENTURE", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"VENTURE", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"VENTURE", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"VENTURE", "checkbudgets", &checkbudgets, true, true, false},
        {"VENTURE", "mnsync", &mnsync, true, true, false},
        {"VENTURE", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> VENTURE-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:32230/\n";
}
