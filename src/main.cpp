...
#if defined(NDEBUG)
#error "VENTURE cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in uVEN) are considered zero fee (for relaying and mining)
...
int64_t GetBlockValue(int nHeight)
{
	...
	if (nHeight == 0)
		...
		nSubsidy = 1 * COIN;
	else if (nHeight > 10001 && nHeight <= 50000000)
		nSubsidy = 10 * COIN;
	else if (nHeight > 50000001 && nHeight <= 60000000)
		nSubsidy = 9 * COIN;
	else if (nHeight > 60000001 && nHeight <= 70000000)
		nSubsidy = 8 * COIN;
	else if (nHeight > 70000001 && nHeight <= 80000000)
		nSubsidy = 7 * COIN;
	else if (nHeight > 80000001 && nHeight <= 90000000)
		nSubsidy = 6 * COIN;
	else if (nHeight > 90000001 && nHeight <= 100000000)
		nSubsidy = 5 * COIN;
	else
		nSubsidy = 1 * COIN;
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // VEN: We use certain sporks during IBD, so check to see if they are
