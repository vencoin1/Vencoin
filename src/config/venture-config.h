/* src/config/venture-config.h.  Generated from venture-config.h.in by configure.  */
/* src/config/venture-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_NAME "VENTURE Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "VENTURE Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "venture"
