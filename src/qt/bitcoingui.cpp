                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("VENTURE Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a VEN address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and venture: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About VENTURE Core"), this);
    aboutAction->setStatusTip(tr("Show information about VENTURE Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for VENTURE"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your VEN addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified VEN addresses"));
    ...
    openAction->setStatusTip(tr("Open a venture: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the VENTURE Core help message to get a list with possible VENTURE command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("VENTURE Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("VENTURE Core"); // default title
