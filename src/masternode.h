...
inline int64_t MasternodeCollateralLimitBM(int nHeight)
{
	...
	//if (nHeight <= 1440)
	//	nSubsidy = 250;
	//else if (nHeight >= 1441 && nHeight <= 20160)
	//	nSubsidy = 500;
	//else if (nHeight >= 20161 && nHeight <= 43200)
	//	nSubsidy = 1000;
	//else if (nHeight >= 43201 && nHeight <= 86400)
	//	nSubsidy = 3000;
	//else if (nHeight >= 86401 && nHeight <= 129600)
	//	nSubsidy = 7000;
	//else if (nHeight >= 129601 && nHeight <= 172800)
	//	nSubsidy = 14000;
	//else if (nHeight >= 172801 && nHeight <= 216000)
	//	nSubsidy = 14000;
	//else if (nHeight >= 216001 && nHeight <= 259200)
	//	nSubsidy = 15000;
	//else if (nHeight >= 259201)
	//	nSubsidy = 15000;
	//else
	//	nSubsidy = 15000;
...
//
// The Masternode Class. It contains the input of the VEN collateral, signature to prove
