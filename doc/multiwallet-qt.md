...
In order to support loading of multiple wallets in venture-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is venture.cpp.
...
Changes to venture.cpp
----------------------
venture.cpp is the entry point into venture-qt, and as such, will require some minor modifications to provide hooks for
