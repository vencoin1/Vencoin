...
This mechanism has been integrated into Bitcore-Node-VENcoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/venture/insight-api-venture#web-socket-api](https://github.com/venture/insight-api-venture#web-socket-api)
* API: [https://github.com/venture/insight-api-venture#swifttx-transactions](https://github.com/venture/insight-api-venture#swifttx-transactions)
...
By default, the VENTURE Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the VENTURE Core daemon:
