...
Intro
-----
VENTURE (VEN) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. VENTURE utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run venture-qt.exe.

VENTURE Core is the original VENTURE client and it builds the backbone of the network.
However, it downloads and stores the entire history of VENTURE transactions;
