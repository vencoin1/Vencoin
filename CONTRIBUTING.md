Contributing to VENTURE Core
==================================

The VENTURE Core project operates an open contributor model where anyone is
...
The following applies to code changes to the VENTURE Core project, and is not to be
confused with overall VENTURE Network Protocol consensus changes.

Whether a pull request is merged into VENTURE Core rests with the project merge
...
Patches that change VENTURE consensus rules are considerably more involved than
...
Where a patch set proposes to change the VENTURE consensus, it must have been
...
The project leader is the release manager for each VENTURE Core release.
