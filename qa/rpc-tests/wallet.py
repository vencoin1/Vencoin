...
#   c) node1 mines 32 blocks, so now node 0 has 500000VEN, node 1 has 4250VEN, node2 has none.
#   d) node0 sends 601 VEN to node2, in two transactions (301 VEN, then 300 VEN).
