...
Setup
---------
Configuring the github-merge tool for the VENTURE repository is done in the following way:

    git config githubmerge.repository venture/venture
...
A script to optimize png files in the VENTURE
...
If there are 'unsupported' symbols, the return value will be 1 a list like this will be printed:
    ...
    .../64/test_venture: symbol memcpy from unsupported version GLIBC_2.14
    .../64/test_venture: symbol __fdelt_chk from unsupported version GLIBC_2.15
    .../64/test_venture: symbol std::out_of_range::~out_of_range() from unsupported version GLIBCXX_3.4.15
    .../64/test_venture: symbol _ZNSt8__detail15_List_nod from unsupported version GLIBCXX_3.4.15
