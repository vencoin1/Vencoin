...
RESOURCES += src/qt/venture.qrc src/qt/venture_locale.qrc

TRANSLATIONS += src/qt/locale/venture_bg.ts \
                src/qt/locale/venture_de.ts \
                src/qt/locale/venture_en.ts \
                src/qt/locale/venture_es.ts \
                src/qt/locale/venture_fi.ts \
                src/qt/locale/venture_fr.ts \
                src/qt/locale/venture_it.ts \
                src/qt/locale/venture_ja.ts \
                src/qt/locale/venture_pl.ts \
                src/qt/locale/venture_pt.ts \
                src/qt/locale/venture_ru.ts \
                src/qt/locale/venture_sk.ts \
                src/qt/locale/venture_sv.ts \
                src/qt/locale/venture_vi.ts \
                src/qt/locale/venture_zh_CN.ts \
                src/qt/locale/venture_zh_TW.ts
